...
const Navbar = () => {
  ...
  return (
    <div className='w-full flex py-6 justify-between items-center navbar'>
        <img className='w-[124px] h-[32px]'  alt='hookbank' src={logo}/>
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
                <img alt='menu' src={toggle ? close : menu} onClick={()=> setToggle((prev)=> !prev)} className='w-[28px] h-[28px] object-contain' />
        </div>
